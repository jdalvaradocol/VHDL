...
HD_PWD='D:/Google Drive/VIVADO/sumador_4bits/sumador_4bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sumador_4bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sumador_4bits.tcl
