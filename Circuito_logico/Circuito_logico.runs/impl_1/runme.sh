...
HD_PWD='E:/Cloud/OneDrive - Universidad de Cundinamarca/Programacion/VIVADO/Circuito_logico/Circuito_logico.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log diagrama.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source diagrama.tcl -notrace
