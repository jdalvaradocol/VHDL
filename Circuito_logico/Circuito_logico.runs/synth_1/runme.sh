...
HD_PWD='E:/Cloud/OneDrive - Universidad de Cundinamarca/Programacion/VIVADO/Circuito_logico/Circuito_logico.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log diagrama.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source diagrama.tcl
